...
export async function deleteAllChatsByUserId({ userId }: { userId: string }): Promise<any> { return; }
export async function getChatsByUserId(_args: any): Promise<any> { return []; }
export async function getChatById({ id }: { id: string }): Promise<any> { return null; }
...
export async function saveDocument({ id, title, kind, content, userId }: any): Promise<any> { return { id }; }
export async function updateDocumentContent({ id, content }: any): Promise<any> { return { id, content }; }
export async function getDocumentsById({ id }: { id: string }): Promise<any> { return []; }
...
export async function getSuggestionsByDocumentId({ documentId }: { documentId: string }): Promise<any> { return []; }
...
export async function getMessageById({ id }: { id: string }): Promise<any> { return []; }
